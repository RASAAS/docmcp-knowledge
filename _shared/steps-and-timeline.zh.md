...
category: _shared
status: active
source_url: https://reguverse.com/documentation/nmpa-erps-docs/steps-and-timeline/
...
确认产品分类、注册单元等信息。如无法确认，或存在其他问题，可申请[受理前咨询](<https://www.cmde.org.cn/sqrzc/zxfw/lcjtcn/lcjtslqzx/index.html>)。

### 2\. 准备样品并委托检验

根据产品特征及性能确认检验样品，编写产品技术要求，委托[具有资质的实验室](<http://cma.cnca.cn/cma/solr/tBzAbilitySearch/list>)进行产品检验，并取得检验报告。根据产品的复杂程度，检验完成时间可持续3-6个月甚至更长。

此外，具有检验能力且符合要求的注册人也可以[自行检验](<https://www.cmde.org.cn/flfg/fgwj/ggtg/20211022162200171.html>)。
