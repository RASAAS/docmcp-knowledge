...
clinical considerations associated with the development of BCI devices.1 FDA considered the 
...
provide all relevant device descriptive characteristics, as outlined in Section III(A) and 
Section III(L) above. 
...
a. Pulses per burst; 
b. Bursts per second; 
c. Burst duration (seconds); and 
d. Duty Cycle [Line a X Line b] 
ON Time12 (seconds) 
OFF Time12 (seconds) 
...
1Output Channels: The number of independently controlled circuits. For example, two leads that 
