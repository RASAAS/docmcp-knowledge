...
**Topics**: GUDID, Labeling, UDI
**Docket**: FDA-2013-D-0636

::: tip Official Source
[https://www.fda.gov/regulatory-information/search-fda-guidance-documents/global-unique-device-identification-database-gudid](https://www.fda.gov/regulatory-information/search-fda-guidance-documents/global-unique-device-identification-database-gudid)
PDF: [https://www.fda.gov/media/86569/download](https://www.fda.gov/media/86569/download)
:::
...
1740. Identify all comments with the docket number FDA-2013-D-0636. Comments may not be 
...
Guidance@fda.hhs.gov to receive a copy of the guidance. Please include the document 
numberGUI00001831 and complete title of the guidance in the request.
CBER
Additional copies are available from the Center for Biologics Evaluation and Research (CBER), 
Office of Communication, Outreach and Development,
10903 New Hampshire Ave, Bldg. 71, Room 3128, Silver Spring, MD 20993, or by calling 1-
800-835-4709 or 240-402-7800, by email ocod@fda.hhs.gov, or from the Internet at 
...
1 The UDI Final Rule (http://www.fda.gov/udi) defines labeler as “any person who causes a label to be applied to a 
...
o
and, for an HCT/P regulated as a device, the distinct identification 
code required by 21 CFR 1271.290(c)5.
2 Refer to the UDI Final Rule (http://www.fda.gov/udi ) for details on issuing agencies and their role in UDI 
assignment.
...
5 21 CFR 1271.290(c) requires that the manufacturer of each HCT/P assign and label the HCT/P with a distinct 
...
o
Dun & Bradstreet (D&B) Number (DUNS)10
o
Global Medical Device Nomenclature (GMDN)11
o
FDA Product Codes
·
...
7 HL7 is a standards development organization, whose mission is to provide messaging standards for 
...
8 Structured Product Labeling (SPL) is a HL7 standard for the exchange of product information using extensible 
markup language (XML).
9 FDA ESG enables the secure submission of regulatory information. For more information, please visit: 
http://www.fda.gov/esg.
10 Data Universal Numbering System or D-U-N-S® Number is a unique nine-digit identification number assigned and 
managed by Dun & Bradstreet to business entities. For more information, visit Business Entity Identifiers | FDA.
11 Global Medical Device Nomenclature (GMDN) is system of internationally agreed descriptors used to identify 
...
o
This DUNS number represents the labeler’s view of the highest corporate level in the 
...
o
Please ensure that the name and address in the D&B DUNS database is accurate, as 
...
12 GUDID Account user contact information provided is for FDA internal use only; not available via GUDID public 
...
o
Each LDE user is assigned one or more labelers, identified by Labeler DUNS 
...
o
A given Labeler DUNS Number can be assigned to more than one LDE user. The 
LDE users would then share responsibility for DI records associated to that Labeler 
DUNS number.
The labeler has the option to designate third-party submitters for GUDID submissions. A third-
party submitter is a company/individual (e.g., contractor, vendor) authorized to submit GUDID 
...
o
Provide software solution/tool to generate the HL7 SPL xml file; you, the labeler, 
would then submit the file via the FDA ESG. or,
o
Provide end-to-end solution to the labeler, i.e., generate the HL7 SPL xml file, and 
...
13 GUDID Account user contact information provided is for FDA internal use only; not available via GUDID public 
search and retrieval.
...
o
If your company does not have a DUNS number, you can obtain one free of charge 
...
o
If you plan to use a third-party to serve as the Regulatory Contact for GUDID as 
...
o
Obtain third-party DUNS number after ensuring that they have verified their 
...
o
List of Labeler DUNS that is the responsibility of the Coordinator; if there are 
...
o
HL7 SPL submitters should first complete testing as specified in the HL7 SPL 
...
LDE users. 
o
Coordinator should have the following information to create an LDE user account: 
14 For detailed information on logging in and using GUDID for each user role refer to the Global Unique Device 
...
o
Once accounts are created, the LDE user receives a temporary login and password via 
...
o
Under 21 CFR 830.40(a), a version or model of a device may be identified using only 
...
DI.
o
Unit of Use DI: A virtual identifier assigned to an individual medical device when a 
...
o
Direct Marking DI16: An identifier that is permanently marked directly on the medical 
...
o
Package DI: A device identifier for the package configuration that contains multiple 
...
o
Previous DI: A device identifier that was assigned to a given version/model of a 
...
o
The device will still be in the database and available via public search, but will be 
...
16 Refer to the FDA guidance documents titled “Unique Device Identification: Direct Marking of Devices” and 
...
17 The UDI Final Rule defines a Shipping Container as a container used during the shipment or transportation of 
...
o
Package DI – DI for the particular package configuration (does not include shipping 
containers).
o
Contains DI Package – DI for the lower level package configuration contained within 
that particular package configuration (what is the DI for the package inside this 
package?).
o
Quantity per Package – number of packages contained within the particular package 
configuration with a unique DI (how many packages are inside this package?).
o
Package Type – optional text to describe the outer packaging of the product (e.g., box, 
carton) and enables users to understand higher-level packaging configurations.
o
Package Discontinue Date – indicates the date a particular package configuration is 
discontinued by the labeler.
o
Package Status – indicates whether the package configuration is in commercial 
...
18Device Identifiers used in the example are fictitious. Please refer to “UDI Formats by FDA Accredited Issuing 
...
o
When selecting a GMDN Term, be advised that GMDN Term Definitions may 
...
o
Term fitness – determine if this GMDN Term or device category best represents the 
device
o
Term Status – determine if terms are “active” or have been made “obsolete”
o
If your company’s GMDN Term Codes have been designated as “obsolete,” identify 
...
o
Editing within-the-Grace-Period
§
All attributes, except Publish Date can be edited.
o
Editing after-the-Grace-Period will be limited
§
...
explained below.
20 For detailed information on the accessing and creating DI records in GUDID, refer to, Global Unique Device 
Identification Database (GUDID) User Manual.
...
21 Draft DI records cannot be submitted via the HL7 SPL submission option.
...
o
A Draft DI record is purged from the system, i.e., permanently removed from 
GUDID, after 180 days of inactivity.
o
Each time a Draft DI record is edited, the 180 calendar day clock is reset as 
...
o
Coordinator and Labeler Data Entry user roles are optional for HL7 SPL submissions 
...
o
Complete ESG account establishment and testing process. Visit www.fda.gov/esg for 
more information.
·
...
o
We are enabling third-parties to test their GUDID HL7 SPL submission solution 
...
Count = 100.
o
Note that the tubes themselves do not have the DI on them as they fall under the 
...
23 Device Identifiers used in all the examples are fictitious. Please refer to “UDI Formats by FDA Accredited Issuing 
...
Companies/individuals (contractors, vendors) authorized to submit 
GUDID information on behalf of the Labeler. 
Unique Device Identifier 
(UDI) 
A unique numeric identifier composed of the device identifier and 
...
DI record that has passed GUDID business rules AND Publish
Date > today.
