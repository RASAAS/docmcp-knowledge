---
title: "Custom Device Exemption: Guidance for Industry and Food and Drug Administration Staff"
...
**Topics**: Premarket
**Docket**: FDA-2013-D-1601

::: tip Official Source
[https://www.fda.gov/regulatory-information/search-fda-guidance-documents/custom-device-exemption](https://www.fda.gov/regulatory-information/search-fda-guidance-documents/custom-device-exemption)
PDF: [https://www.fda.gov/media/89897/download](https://www.fda.gov/media/89897/download)
:::
...
Regulatory Programs 1 (Submission Support) at 301-796-5640 or customdevices@fda.hhs.gov.
...
B. 
The custom device exemption describes two types of custom devices: one specific to the special needs 
...
G. 
If a patient needs to undergo revision surgery to replace a component of her implant that is no longer 
...
1 For the readability of this document, the word “physician” is defined to represent “physician or dentist (or any 
...
2 See 21 CFR 860.3(i). 
3 See, e.g., 21 CFR 806.2(f). 
4 48 FR 248 Pages 56778, 56796, December 23, 1983.
...
patients for the patient-focused custom device or five new physicians for the physician-
focused custom device, assuming all other required elements for the custom device 
...
5 A device not covered by an existing marketing approval would require either a PMA or a valid exemption 
...
6
applicable requirements.6 FDA recognizes there may be limited circumstances under 
...
It is worth noting that FDA reviews, clears, and approves for marketing many patient-
specific devices (also referred to as patient-matched devices). Patient-specific devices 
...
6 See Section 520(g) of the FD&C Act and 21 CFR Parts 50, 56, and 812, Investigational Device Exemptions 
...
reporting to FDA. 
7 CDRH has received 510(k)s and PMA applications for patient-specific/patient-matched medical devices in a 
...
8 For additional information on device labeling, refer to 21 CFR Part 801, 21 CFR 809.10, and “Guidance on 
...
9 This is not intended to exhaustively list devices that might satisfy the custom device exemption and represents 
...
9
should request custom occipitocervical implants for non-standard, pediatric sized 
...
FDA issued a call for comments10 on the use of custom devices in developing this 
guidance document. We received no examples describing a potential physician-
centric custom device. Assuming all other aspects of the custom device exemption in 
...
10 See 77 FR 69488 (Monday, November 19, 2012).
...
11 
Attn: Custom Device Annual Report Submission Coordinator 
...
As described in Section V.B. of this guidance, a custom device is either patient-
centric or physician-centric, but not both. In addition to the requested elements listed 
...
11 See Section VII of this guidance document for the complete text contained in section 520(b) of the FD&C 
Act.
...
12 See Section VII of this guidance document for the complete text contained in section 520(b) of the FD&C 
Act.
...
13 Section 520(b)(2)(C) of the FD&C Act now requires that custom device manufacturers submit annual reports 
...
U.S.C. 3501-3520). 
The time required to complete this information collection is estimated to average forty 
hours per response, including the time to review instructions, search existing data sources, 
...
The OMB control number for this information collection is 0910-0767 (To find the 
