---
title: "Leveraging Existing Clinical Data for Extrapolation to Pediatric Uses of Medical Devices: Guidance for Industry and Food and Drug Administration Staff"
...
**Topics**: Premarket, Good Clinical Practice (GCP), Pediatric Product Development, Premarket Approval (PMA), HUD/HDE
**Docket**: FDA-2015-D-1376

::: tip Official Source
[https://www.fda.gov/regulatory-information/search-fda-guidance-documents/leveraging-existing-clinical-data-extrapolation-pediatric-uses-medical-devices](https://www.fda.gov/regulatory-information/search-fda-guidance-documents/leveraging-existing-clinical-data-extrapolation-pediatric-uses-medical-devices)
PDF: [https://www.fda.gov/media/91889/download](https://www.fda.gov/media/91889/download)
:::
...
6405 (Jacqueline.Francis@fda.hhs.gov), CDRHPediatricExtrapolation@fda.hhs.gov,  or 
the Office of Communication, Outreach, and Development (CBER) at 800-835-4709 or 
240-402-8010.  
...
2015-D-1376].  Comments may not be acted upon by the Agency until the document is 
...
document number (1827) to identify the guidance you are requesting. 
...
(OCOD), 10903 New Hampshire Ave., WO71, Room 3128, Silver Spring, MD 20903, or 
by calling 1-800-835-4709 or 240-402-8010, by email, ocod@fda.hhs.gov, or from the 
Internet at  
...
2. Overview ......................................................................................................................... 5 
3. Background ..................................................................................................................... 7 
4. Why Extrapolate Adult Data for Pediatric Use? ........................................................... 10 
5. Borrowing Strength from Adult Data ........................................................................... 11 
5.1 Full and Partial Extrapolation ................................................................................. 12 
5.2 Extrapolation for Effectiveness vs. Safety .............................................................. 13 
6. Pediatric Extrapolation Decision Process……………………………………………..14 
6.1 Pediatric Extrapolation Decision Tree .................................................................... 14 
6.2 Questions in the Pediatric Extrapolation Decision Tree ......................................... 17 
7. Factors that Could Limit Extrapolation ........................................................................ 21 
8. Uncertainty in Extrapolating Data ................................................................................ 22 
9. Statistical Methodology for Extrapolation .................................................................... 23 
9.1 The Bayesian Hierarchical Model and Exchangeability of Studies........................ 24 
9.2 Age-Related Covariates Associated With Device Outcomes ................................. 25 
Appendix A. Examples of the Decision Process for Extrapolation .................................. 27 
A.1 A Hypothetical Example of Full Extrapolation ..................................................... 27 
A.2 A Hypothetical Example of Partial Extrapolation with Relevant Age-Associated 
Differences between Populations Accounted for Via Modeling .................................. 28 
A.3 A Hyopthetical Example of Partial Extrapolation ................................................. 29 
A.4 Hypothetical Examples where Extrapolation is not Recommended ...................... 29 
A.4.1 Hypothetical Example where Extrapolation is not Recommended because of Quality 
of Data ................................................................................................................................... 29 
A.4.2 Hypothetical Example where Extrapolation is not Recommended because of Relevant 
Differences ............................................................................................................................ 30 
A.5 An Example of an Actual Extrapolation ................................................................ 30 
Appendix B: Details on Statistical Modeling for Extrapolation ....................................... 33 
B.1 A Three-Level Hierarchical Model ........................................................................ 33 
B.3 Age-Related Covariates Associated With the Device Effect or Outcome ............. 34 
B.4. Extrapolation From a Single Adult Study ............................................................. 35 
B.5 Additional Methods for Extrapolation ................................................................... 35 
References ......................................................................................................................... 37 
 
Figures and Tables 
Figure 1. Pediatric Extrapolation Decision Tree ............................................................... 16 
Figure 2. Three-Level Hierarchical Model Structure Example: Studies Within Patient 
Populations Have Different But Related Effects .............................................................. 34
...
This guidance does not change the regulatory threshold for valid scientific evidence.  
...
This guidance explains when and how existing clinical data in another studied population 
...
documents may provide more details to comprehensively address the issues related to the 
...
In 2004, FDA published a guidance document entitled “Premarket Assessment of 
...
the safety and effectiveness of medical devices intended for use in the 
...
expected to occur rarely. The appropriateness of extrapolation for effectiveness and/or 
...
of 13 and 21 because it is widely accepted that cerebral vasculature of this age group is 
...
can bolster the sample size of a prospective pediatric study.  The exact model used to 
...
this alongside other data sources, such as virtual patient simulations, bench data, 
...
likely also not be warranted.  However, we believe that there are cases where 
...
adult or other extrapolated data related to that condition and/or the effect of the device are 
...
Figure 1. Pediatric Extrapolation Decision Tree 
...
used to explore such options.13 A post-market surveillance study may be required, 
...
of the proposed device in pediatric patients.  The questions in Box C serve to address 
...
The kinetics or physiology might differ between adults and children, which might then 
...
Staff—Design Considerations for Pivotal Clinical Investigations for Medical Devices,”15 
...
FDA’s “Guidance for Industry and Food and Drug Administration Staff Factors to 
...
modeling, as well as other methods mentioned in Appendix B, do not directly pool all 
patients together. 
...
then within each category, the adult studies might be exchangeable with the pediatric 
...
A.2 A Hypothetical Example of Partial Extrapolation with 
...
In many cases, a control or comparator is not available for pediatrics but it is available for 
...
would determine that the adult data in this case are not of sufficient quality for either full 
...
• Pediatric patients often have? complex health histories (many leading to early 
mortality) 
...
the number of pediatric patients that would be prospectively enrolled to confirm 
...
Appendix B: Details on Statistical Modeling for 
Extrapolation 
...
Figure 2. Three-Level Hierarchical Model Structure Example: Studies Within 
...
available, the assumed model would be checked against the data to ensure it is still valid.  
...
in many cases the overall conclusions will remain the same, and the Bayesian 
...
(2007). Appendix D: Standard terminology for reporting reproductive health statistics. 
In Guidelines for perinatal care, 6th. ed. (pp. 389–404). Elk Grove Village, IL: 
American Academy of Pediatrics. 
 
Carlin, B., & Louis, T. (2009). Bayesian methods for data analysis. Boca Raton, FL: 
CRC Press. 
 
Hobbs, B. P., Carlin, B. P., Mandekar, S. J., & Sargent, D. J. (2011). Hierarchical 
commensurate and power prior models for adaptive incorporation of historical 
information in clinical trials. Biometrics, 67, 1047–1056. 
 
Hobbs, B., Sargent, D., & Carlin, B. (2012). Commensurate priors for incorporating 
historical information in clinical trials using general and generalized linear models. 
Bayesian Analysis, 7, 1–36. 
...
Yue, L. Q. (2012). Regulatory considerations in the design of comparative observational 
studies using propensity scores. Journal of Biopharmaceutical Statistics, 22(6), 1272–
1279(8).  
 
Yue, L. Q. (2007). Statistical and regulatory issues with the application of propensity 
score analysis to nonrandomized medical device clinical studies. Journal of 
Biopharmaceutical Statistics, 17, 1–13.
