...
::: tip Official Source
[https://www.fda.gov/regulatory-information/search-fda-guidance-documents/guidance-use-bayesian-statistics-medical-device-clinical-trials-pdf-version](https://www.fda.gov/regulatory-information/search-fda-guidance-documents/guidance-use-bayesian-statistics-medical-device-clinical-trials-pdf-version)
PDF: [https://www.fda.gov/media/71512/download](https://www.fda.gov/media/71512/download)
:::
...
For questions regarding this document, contact Dr. Greg Campbell (CDRH) at 301-796-
5750 or greg.campbell@fda.hhs.gov or the Office of Communication, Outreach and 
...
4. 
Planning a Bayesian Clinical Trial ....................................................................................................... 19 
...
of the statistical issues that arise in Bayesian clinical trials, it is not intended to be all-
inclusive.  The statistical literature is rich with books and papers on Bayesian theory 
...
2 The FFDCA provides for two types of early collaboration meetings: 
...
<!-- Page 10 -->
commonly seen in device labeling3.  As always, we recommend you ensure 
...
making Bayesian calculations is called WinBUGS4. The acronym BUGS 
...
3 However, one example can be seen at INTERFIX labeling at (SSE:  
...
assurance of safety and effectiveness of a new device, often through pre-
specified decision rules.  Traditional hypothesis testing is an example of a 
...
observing any particular set of outcomes on those units is invariant to any re-
ordering of the units.  This definition can be made clearer through examples. 
...
7 See 21 CFR 812.20(b)(2) and 21 CFR 812.27.  
22
...
the values or lack of information can be represented through a non-
informative prior distribution (such as Figure 2). 
...
effectiveness.  At the same time, the approach can protect against over-
reliance on previous studies that turn out to be overly optimistic for the pivotal 
study parameter. 
...
The degree to which we might relax the type I error control is a case-by-
case decision that depends on many factors, primarily the confidence we 
...
If patients have measurements of the same outcome at earlier and later follow-
up visits, you may make predictions for the later follow-up visit (even before 
...
http://www.accessdata.fda.gov/scripts/cdrh/cfdocs/cfTopic/pma/pma.cfm?num=p980
048. 
11 See Summary of Safety and Effectiveness for PMA P970015 at    
http://www.accessdata.fda.gov/scripts/cdrh/cfdocs/cfTopic/pma/pma.cfm?num=p970
015. 
34
...
12 See the Summary of Safety and Effectiveness for PMA P970015 at 
http://www.accessdata.fda.gov/scripts/cdrh/cfdocs/cfTopic/pma/pma.cfm?num=p970
015).   
35
...
approval.  In other words, you may readily update information provided by a pre-
market clinical trial with post-market data via Bayes’ theorem if you can justify 
...
used in the analysis with the PMA submission13.  (Note we do NOT want the 
...
14 In a regulatory setting, it is of paramount concern if the result of current study is substantially 
...
should note, however, that Bayes Factors are not well-defined for some non-
informative priors, specifically when the prior distribution is improper (does not 
...
15  Both programs may be downloaded from the Medical Research Center, 
Cambridge, at 
