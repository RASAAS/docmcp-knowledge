...
PDF: [https://www.fda.gov/media/77635/download](https://www.fda.gov/media/77635/download)
:::
...
Level of Concern. Based on the device’s risk in the context of the device’s intended use, as 
discussed in the final guidance “Content of Premarket Submissions for Device Software 
Functions,” computer-assisted detection (CADe) devices applied to radiology images and 
...
a premarket submission, sponsors are encouraged to review the guidance “Content of Premarket 
...
health care professional), referred to as the “clinician” in this document. We have considered the 
...
1 The use of the acronym CADe for computer-assisted detection may not be a generally recognized acronym in the 
community at large. It is used here to identify the specific type of devices discussed in this document. 
2 Available at https://wayback.archive-
...
3 Available at https://wayback.archive-
...
concerning the specific content of a 510(k) submission, including the guidance “Format for 
...
in the 21st Century Cures Act” (86 FR 20278).6 
...
4 See 74 FR 54053 at https://www.federalregister.gov/documents/2009/10/21/E9-25233/draft-guidances-for-
industry-and-food-and-drug-administration-staff-computer-assisted-detection. 
5 Available at https://www.fda.gov/regulatory-information/search-fda-guidance-documents/format-traditional-and-
abbreviated-510ks. 
6 See 86 FR 20278 at https://www.federalregister.gov/documents/2021/04/19/2021-07860/medical-devices-medical-
...
FDA guidance entitled “Clinical Performance Assessment: Considerations for Computer-
Assisted Detection Devices Applied to Radiology Images and Radiology Device Data in 
Premarket Notification (510(k)) Submissions.”8 
 
Common scoring criteria that have been used to determine the nature of each CADe detection 
 
8 Available at https://www.fda.gov/regulatory-information/search-fda-guidance-documents/clinical-performance-
assessment-considerations-computer-assisted-detection-devices-applied-radiology.
...
J. 
Other Information 
We recommend that you include software documentation following the “Guidance for the 
Content of Premarket Submissions for Software Contained in Medical Devices”9 and the FDA 
guidance “Off-the-Shelf Software Use in Medical Devices.”10 The kind of information we that 
recommend submitting is determined by the “level of concern,” which is related to the risks 
...
that are known to challenge clinicians, but that still fall within the device’s intended use 
...
CADe device’s standalone performance, you should demonstrate that reusing any part of the test 
...
“firewall” to ensure those outside of the regulatory assessment team (e.g., algorithm developers) 
...
clinical trial data monitoring committees and the use of a “firewall” to insulate personnel
...
to Section 4.4.1.4 of the FDA guidance entitled “Establishment and Operation of Clinical Trial 
Data Monitoring Committees.”12 
...
12 Available at https://www.fda.gov/regulatory-information/search-fda-guidance-documents/establishment-and-
...
false positive rate14 (e.g., the average number of false positive marks per case [FPs/case]) at each 
...
13 Miller, D.P., O’Shaughnessy, K.F., Wood, S.A., and Castellino M.D., R.A., Gold standards and expert panels: a 
...
14 Standalone specificity (i.e., the fraction of normal cases without a CADe mark) may be applicable instead of 
standalone false positive rate for some CADe algorithms that have very few false positive detections. 
15 Efron, B.,Tibshirani, R., Bootstrap Methods for Standard Errors, Confidence Intervals, and Other Measures of 
...
16 Samuelson, F.W., and Petrick, N., Comparing image detection algorithms using resampling. 3rd IEEE 
...
“Statistical Guidance on Reporting Results from Studies Evaluating Diagnostic Tests.”17 
...
the FDA white paper entitled Clinical Data for Premarket Submissions, and also FDA’s webpage 
on the eCopy Program18 and the FDA guidance entitled “eCopy Program for Medical Device 
Submissions.”19 
...
17 Available at https://www.fda.gov/regulatory-information/search-fda-guidance-documents/statistical-guidance-
reporting-results-studies-evaluating-diagnostic-tests-guidance-industry-and-fda. 
18 Available at https://www.fda.gov/medical-devices/how-study-and-market-your-device/ecopy-program-medical-
device-submissions. 
19 Available at https://www.fda.gov/regulatory-information/search-fda-guidance-documents/ecopy-program-
...
consult the guidance entitled “Clinical Performance Assessment: Considerations for Computer-
Assisted Detection Devices Applied to Radiology Images and Radiology Device Data in 
Premarket Notification (510(k)) Submissions.”20 
...
20 Available at https://www.fda.gov/regulatory-information/search-fda-guidance-documents/clinical-performance-
assessment-considerations-computer-assisted-detection-devices-applied-radiology.
...
“Statistical Guidance on Reporting Results from Studies Evaluating Diagnostic Tests.”21 
...
electronically, please see the FDA webpage on the eCopy Program22 and the FDA guidance 
entitled “eCopy Program for Medical Device Submissions.”23 
...
21 Available at https://www.fda.gov/regulatory-information/search-fda-guidance-documents/statistical-guidance-
reporting-results-studies-evaluating-diagnostic-tests-guidance-industry-and-fda.  
22 Available at https://www.fda.gov/medical-devices/how-study-and-market-your-device/ecopy-program-medical-
device-submissions. 
23 Available at https://www.fda.gov/regulatory-information/search-fda-guidance-documents/ecopy-program-
medical-device-submissions.
...
24 Although final labeling is not required for 510(k) clearance, final labeling must comply with the requirements of 
...
guidance entitled “Clinical Performance Assessment: Considerations for Computer-Assisted 
Detection Devices Applied to Radiology Images and Radiology Device Data in Premarket 
Notification (510(k)) Submissions.”25 
...
25 Available at https://www.fda.gov/regulatory-information/search-fda-guidance-documents/clinical-performance-
assessment-considerations-computer-assisted-detection-devices-applied-radiology.
