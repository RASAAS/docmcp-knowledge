---
title: "Investigational Device Exemptions (IDEs) for Early Feasibility Medical Device Clinical Studies, Including Certain First in Human (FIH) Studies: Guidance for Industry and Food and Drug Administration Staff"
...
PDF: [https://www.fda.gov/media/81784/download](https://www.fda.gov/media/81784/download)
:::
...
(IDEs) for Early Feasibility 
Medical Device Clinical Studies, 
Including Certain First in Human 
(FIH) Studies  
 
Guidance for Industry and Food 
and Drug Administration Staff 
      Document issued on: October 1, 2013 
The draft of this document was issued on November 10, 2011.  
For questions regarding this document, contact CDRH’s Andrew Farb, 301-796-6343, 
Andrew.Farb@fda.hhs.gov or Dorothy Abel, 301-796-6366, Dorothy.Abel@fda.hhs.gov, or 
CBER’s Office of Communication, Outreach and Development at 1-800-835-4709 or 301-827-
1800.  
...
Overview ................................................................................................................................... 7 
5. 
Targeting approval for an Early Feasibility Study IDE Application ......................................... 9 
6. 
Report of Prior Investigations ................................................................................................. 10 
6.1 
Content of the Report of Prior Investigations for an early feasibility study IDE ................. 11 
6.2 
Design concept ..................................................................................................................... 12 
6.3 
Device evaluation strategy ................................................................................................... 13 
6.3.1 
Device evaluation strategy for an early feasibility study ................................................ 13 
6.3.2 
Overall device evaluation plan (at the sponsor’s discretion) .......................................... 18 
6.4 
Bench and laboratory testing and computational modeling ................................................. 18 
6.5 
In vivo animal studies ........................................................................................................... 19 
6.6 
Prior clinical information ..................................................................................................... 20 
7. 
Investigational Plan ................................................................................................................. 20 
7.1 
Risk analysis and mitigation ................................................................................................. 20 
7.2 
Clinical protocol ................................................................................................................... 21 
7.3 
Human subject protection measures ..................................................................................... 22 
7.3.1 
Informed consent ............................................................................................................ 22 
7.3.2 
...
7.4.2 
Data monitoring committee (DMC) ............................................................................... 23 
8. 
Iterations during early feasibility studies ................................................................................ 24 
8.1 
Changes requiring FDA notification (5-day notice) ............................................................. 24 
8.2 
Changes requiring FDA approval ......................................................................................... 25 
9. 
Design controls ........................................................................................................................ 27 
10. 
Next steps in clinical evaluation .............................................................................................. 28 
11. 
Conclusion ............................................................................................................................... 28 
Appendix 1: Suggested topics for a Pre-Sub for an early feasibility study IDE .................................. 29 
Appendix 2: Device evaluation strategy example ................................................................................ 30 
Appendix 3: Supplemental guidance for the preparation of an early feasibility study informed consent 
document .............................................................................................................................................. 35 
Appendix 4: Device iteration example ................................................................................................. 38
...
y An early feasibility study is a limited clinical investigation of a device early in 
...
y A first in human (FIH) study is a type of study in which a device for a specific 
...
y A traditional feasibility study is a clinical investigation that is commonly used to 
...
y A pivotal study is a clinical investigation designed to collect definitive evidence of the 
...
into: 
y the clinical safety of the device-specific aspects of the procedure;  
y whether the device can be successfully delivered, implanted or used;  
y operator technique challenges with device use; 
y human factors (e.g., difficulties in comprehending procedural steps); 
y the clinical safety of the device (e.g., evaluation of device-related serious adverse events);  
y whether the device performs its intended purpose (e.g., mechanical function, making 
...
7
y device failures; 
y patient characteristics that may impact device performance (e.g., anatomical limitations); 
and 
y therapeutic parameters (e.g., energy applied, sizing, dose released) associated with device 
use. 
...
y identify appropriate modifications to the procedure or device;  
y optimize operator technique; 
y refine the intended use population; 
y refine nonclinical test plans or methodologies; and   
y develop subsequent clinical study protocols.    
...
describe: 
y the clinical context for the early feasibility study:  
...
assessment options); 
y the design concept; and 
y a summary justification regarding the amount and type of information/data needed to 
...
14 
y Column 1, Device Attribute:  Each procedure-related function, performance-related 
...
of the device. 
y Column 2, Potential Failure Modes:  For each Device Attribute, the types of problems or 
...
y Columns 3 and 4, Potential Device and Clinical Effects of Failure: For each Potential 
Failure Mode, the potential effects of the failure mode on the device and/or study subject 
(i.e., risks).     
y Column 5, Device Design Information: For each Potential Failure Mode, the design 
...
y Columns 6 and 7, Leveraged Nonclinical Information and Supportive Clinical 
...
y Column 8, Nonclinical Device Testing: The bench, laboratory, analytical, and/or animal 
...
y Column 9, Clinical Study Mitigation Strategies: For each Potential Clinical Effect of 
...
y For long-term implants in which the boundary and loading conditions are known, CM 
may be used to predict the long-term durability of the device.     
y For long-term implants in which the boundary and loading conditions are not well-
...
y For certain test scenarios, which cannot be evaluated using other nonclinical methods or 
...
y similar or related devices utilized for the proposed intended use; or 
y the subject device or similar devices used for a different purpose. 
...
27 
2)  Interactive review.  Interactive review involves the continuation of informal discussions 
...
29 
Appendix 1: Suggested topics for a Pre-Sub for an early feasibility 
study IDE  
...
30 
Appendix 2: Device evaluation strategy example 
...
y access the target site;  
y deploy the implantable portion of the device; and  
y withdraw the delivery system.   
For the ‘the ability to access the target site’ attribute, the potential failure modes are: 
y the inability to safely advance the system to the target site; and 
y implant dislodgement from the delivery system. 
...
31 
Table 3: Device Evaluation Strategy Table, Procedure-Related Function – Ability to Access  
Column 1 
Column 2 
Column 3 
Column 4 
...
32 
Table 4: Device Evaluation Strategy Table, Performance-Related Function – Implant Integrity 
Column 
1 
Column 2 
Column 3 
...
33 
Table 5: Device Evaluation Strategy Table, Basic Safety-Related Feature – Biocompatibility 
Column 1 
Column 2 
Column 3 
Column 4 
...
35 
Appendix 3: Supplemental guidance for the preparation of an early 
...
an explanation of whom to contact for answers to questions about the study and the subject's rights 
...
38 
Appendix 4: Device iteration example 
...
y improvements in maneuverability, including: 
...
y changing the length of the catheter to allow for the use of alternative access sites; 
y modifying the hemostatic valve by changing material properties or device dimensions to 
improve hemostasis or reduce friction;  
y implementing ergonomic changes in the handle that do not affect the overall function of 
the device (e.g., changing texture of knobs or handle); and 
y modifying the operator interface console. 
...
39 
Table 6: Regulatory process for anticipated modifications  
Changes that may be 
