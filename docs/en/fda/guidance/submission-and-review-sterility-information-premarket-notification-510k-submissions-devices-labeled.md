...
PDF: [https://www.fda.gov/media/74445/download](https://www.fda.gov/media/74445/download)
:::
...
2 
ethylene oxide (EO), and radiation. FDA has experience with other methods, such as vaporized 
...
3 The implementing regulations for GMP requirements, section 520(f) of the Federal Food, Drug, and Cosmetic Act, 
are referred to as Quality System (QS) requirements (see also 21 CFR Part 820). 
4 Ethylene oxide gas sterilizer, 21 CFR 880.6860, dry-heat sterilizer, 880.6870, and steam sterilizer 880.6880. 
5 See “Guidance on Premarket Notification (510(k)) Submissions for Sterilizers Intended for Use in Health Care 
...
6 Liquid chemical sterilants/high level disinfectants, 21 CFR 880.6885, and Automated endoscope reprocessors 
under Endoscope and accessories, 21 CFR 876.1500. 
7 This characterization scheme applies to processing methods used in manufacturing rather than for specific 
...
8 For more information, please see FDA’s database, Recognized Consensus Standards at 
http://www.accessdata.fda.gov/scripts/cdrh/cfdocs/cfStandards/search.cfm 
9 We encourage you to contact the review division for your device regarding the appropriate parameters to monitor 
...
10 This evaluation may take place as part of the review of a 510(k) submission for a sterilizer intended for use in a 
...
5 
development, validation, and routine control. A Novel Sterilization Method is a method 
...
11 Sterilizers intended for use in healthcare facilities require 510(k)s.  Industrial sterilizers do not require 510(k)s.
...
6 
the identification of a Device Master File12 containing this 
...
12 For more information on Device Master Files, please see https://www.fda.gov/medical-devices/premarket-
approval-pma/master-files  
13 The identification of the sterilization site may be provided in the sterilization section of the 510(k) submission or 
...
14 For more information on pre-submission interactions, please see the guidance “Requests for Feedback on Medical 
...
7 
present for similar systemic exposure; or 
• 
...
8 
contact the relevant review branch as limits vary for specific device types.   
...
16 FDA recommends that package test methods include simulated distribution and associated package integrity, as 
