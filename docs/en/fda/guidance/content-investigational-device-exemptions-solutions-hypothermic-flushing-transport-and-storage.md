---
title: "Content of Investigational Device Exemptions for Solutions for Hypothermic Flushing, Transport and Storage of Organs for Transplantation - Guidance for Industry and FDA Reviewers"
...
::: tip Official Source
[https://www.fda.gov/regulatory-information/search-fda-guidance-documents/content-investigational-device-exemptions-solutions-hypothermic-flushing-transport-and-storage](https://www.fda.gov/regulatory-information/search-fda-guidance-documents/content-investigational-device-exemptions-solutions-hypothermic-flushing-transport-and-storage)
PDF: [https://www.fda.gov/media/71703/download](https://www.fda.gov/media/71703/download)
:::
...
Exemptions for Solutions for
Hypothermic Flushing, Transport
and Storage of Organs for
Transplantation; Guidance for
Industry and FDA Reviewers
Document issued on January 16, 2001
...
For questions regarding the use or interpretation of this guidance contact Kathy Olvey, 
Gastroenterology and Renal Devices Branch, 9200 Corporate Boulevard, HFZ-470, 
Rockville, MD, 20850 or by email at kathleen.olvey@fda.hhs.gov.
...
<!-- Page 4 -->
2
Further guidance may be obtained through pre-IDE submission or meetings with the FDA.  The
...
A. 
A listing of the chemical composition of the solution (including supplier and
...
this product.
B. 
An explanation of the purpose of each chemical component, (e.g., prevention of
swelling, metabolic support, etc.) should be given.
C. 
The description should explain how the solution is to be used (e.g., for perfusion
or static storage), highlighting any unusual features.
D. 
A description of the manufacturing process, including the method of sterilization,
...
3
E. 
A complete description of the packaging material should be provided.  The
...
A. 
Bench testing should address the stability of the product under both proper
...
B. 
Animal testing will normally be necessary to demonstrate the safety of the
...
1. 
A justification for the selected animal model should be provided,
...
2. 
Provide an explanation of specific organ performance parameters that
...
4
3. 
The investigational product should be tested against a control solution.
It is recommended that the control be a solution that is widely used for
preservation of the organ in question.
4. 
The results should be summarized in tabular and graphical format, with
statistical analysis as appropriate.
C. 
Any clinical data obtained with the product, either in the U.S. or at foreign sites,
...
<!-- Page 7 -->
5
at least three sites in order to capture potential differences among transplantation
