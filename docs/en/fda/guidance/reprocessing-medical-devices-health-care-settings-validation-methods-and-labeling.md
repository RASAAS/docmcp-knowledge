---
title: "Reprocessing Medical Devices in Health Care Settings: Validation Methods and Labeling : Guidance for Industry and Food and Drug Administration Staff"
...
**Topics**: Premarket, 510(k), Investigational Device Exemption (IDE), Premarket Approval (PMA)
**Docket**: FDA-2011-D-0293

::: tip Official Source
[https://www.fda.gov/regulatory-information/search-fda-guidance-documents/reprocessing-medical-devices-health-care-settings-validation-methods-and-labeling](https://www.fda.gov/regulatory-information/search-fda-guidance-documents/reprocessing-medical-devices-health-care-settings-validation-methods-and-labeling)
PDF: [https://www.fda.gov/media/80265/download](https://www.fda.gov/media/80265/download)
:::
...
requirements. 
FDA notes that in particular, the QMSR does not utilize certain terms, such as “Design History 
File (DHF),” “Device Master Record (DMR),” “Design Controls,” “Design Validation,” and 
“Process Validation.” The elements that comprise these terms are described in ISO 13485:2016, 
including Clause 4.2 and Clause 7 and its subclauses. The definition of “establish” from 820.3(k) 
is not retained in the QMSR, and ISO 13485:2016, Clause 0.2 clarifies that “document” 
encompasses the activities of establishing, implementing, and maintaining.
...
20852. Identify all comments with the docket number FDA-2011-D-0293. Comments may not be 
...
number 1748 to identify the guidance you are requesting. 
...
1-800-835-4709 or 240-402-7800, by email, ocod@fda.hhs.gov, or from the Internet at  
...
III. SCOPE ................................................................................................................................... 2
Exclusions........................................................................................................................... 3
IV. GENERAL CONSIDERATIONS FOR REUSABLE MEDICAL DEVICES ................ 4
A. 
Design of Reusable Medical Devices ......................................................................... 4
B. 
Ensuring the Safety of Reusable Medical Devices..................................................... 4
V. 
GENERAL CONSIDERATIONS FOR REPROCESSING INSTRUCTIONS IN 
DEVICE LABELING ................................................................................................................... 4
A. 
Overview of Reprocessing .......................................................................................... 5
B. 
Resources for Developing Reprocessing Instructions ................................................ 6
C. 
Human Factors in Developing Reprocessing Instructions .......................................... 7
VI. FDA’S SIX CRITERIA FOR REPROCESSING INSTRUCTIONS ............................... 8
Criterion 1. Labeling should reflect the intended use of the device. ................................ 8
Criterion 2. Reprocessing instructions for reusable devices should advise users to 
thoroughly clean the device. ............................................................................................... 9
Criterion 3. Reprocessing instructions should indicate the appropriate microbicidal 
process for the device.......................................................................................................... 9
Criterion 4. Reprocessing instructions should be technically feasible and include only 
devices and accessories that are legally marketed. ........................................................... 12
Criterion 5. Reprocessing instructions should be comprehensive. ................................. 13
Criterion 6. Reprocessing instructions should be understandable. ................................. 21
VII. VALIDATION OF REPROCESSING METHODS IN ACCORDANCE WITH THE 
QUALITY SYSTEM REGULATION ...................................................................................... 22
VIII. VALIDATION OF CLEANING PROCESS .................................................................. 23
A. 
Validation of the Cleaning Process Using Worst-Case Testing ............................... 23
B. 
Resources for Establishing Simulated Use Protocols ............................................... 27
IX. VALIDATION OF THE FINAL MICROBICIDAL PROCESS TO PREPARE THE 
DEVICE FOR THE NEXT PATIENT ..................................................................................... 28
A. 
Disinfection ............................................................................................................... 28
B. 
Sterilization ............................................................................................................... 28
X. 
FDA REVIEW OF REPROCESSING INSTRUCTIONS AND DOCUMENTATION 
OF REPROCESSING METHOD VALIDATION IN SUBMISSIONS ................................ 28
A. 
Documentation in 510(k)s ......................................................................................... 29
B. 
Documentation in PMAs, HDEs and De Novo Requests ......................................... 30
C. 
Documentation in IDEs ............................................................................................. 30
APPENDIX A.  DEFINITION OF TERMS ............................................................................. 32
APPENDIX B.  OVERVIEW OF REUSABLE MEDICAL DEVICE REPROCESSING .. 35
APPENDIX C.  EXAMPLES OF STERILIZATION CYCLES USED IN HEALTH CARE 
SETTINGS................................................................................................................................... 36
...
APPENDIX D.  DESCENDING ORDER OF RESISTANCE OF MICROORGANISMS 
TO GERMICIDAL CHEMICALS ........................................................................................... 37
APPENDIX E.  DEVICES FOR WHICH A 510(K) SHOULD CONTAIN DATA TO 
VALIDATE REPROCESSING INSTRUCTIONS ................................................................. 38
...
2.  Reusable medical devices initially supplied as non-sterile to the user and requiring the 
...
3 
in Premarket Notification (510(k)) Submissions for Devices Labeled as Sterile” 
...
This document is not intended to provide device-specific recommendations on design, testing, or 
reprocessing validation. You should also follow the recommendations in device-specific 
guidance, when available. 
4 
  
IV. General Considerations for Reusable Medical Devices 
A. 
...
B. 
Ensuring the Safety of Reusable Medical Devices  
...
V. 
General Considerations for Reprocessing Instructions 
in Device Labeling
...
document.  
B. 
Resources for Developing Reprocessing Instructions 
...
§ be subject to reprocessing with disinfectants or other chemicals that might leave 
...
Note that whichever reprocessing method(s) is/are recommended, the compatibility of the 
...
technologies include hydrogen peroxide (H2O2) sterilization, ozone (O3) sterilization, 
...
recommended for use by CDC may include the use of specific disinfectants and 
...
http://www.fda.gov/MedicalDevices/DeviceRegulationandGuidance/ReprocessingofReus
13 
...
The instructions should describe any accessories that are needed for safe 
...
If reassembly is to be performed by the surgeon and is described in the surgeon’s 
...
The instructions should recommend only cleaning agents or classes of agents (e.g., 
...
F. Rinsing 
16 
The labeling should recommend specific directions for rinsing to remove chemical 
...
17 
Use of lubricating agents is an effective way of extending the use life of some 
...
Specifications for sterilization equipment and sterilization cycle parameters vary with 
...
§ Chamber load – Labeling should describe the chamber load; for example, if 
...
19 
Labeling should include instructions for reducing sterilant residuals (e.g., by 
...
L. Reuse Life 
20 
The labeling should either 1) inform the user how many times the device can be 
...
21 
Devices that are intended to be maintained by a patient or lay care provider (e.g., 
...
disinfection or sterilization, final rinsing after disinfection or liquid chemical sterilization, 
...
VII. Validation of Reprocessing Methods in Accordance with 
...
characteristics of the user population and operating environment are considered, in accordance 
...
A. 
Validation of the Cleaning Process Using Worst-Case Testing 
...
23 
Implementation of a well-established, simulated use test protocol should be an 
...
an actual clinical use, and would create the greatest (worst-case) challenge to the 
...
b. Inoculation Sites 
24 
Soil inoculations should mimic worst-case clinical use conditions. We 
...
manipulations) for which the device is intended in order to soil the device 
...
§ 
Negative sample control – “Extraction” is conducted with no device. This 
...
c. Extraction Method 
27 
Devices should be subjected to a validated method of extraction for recovery of 
...
life. 
B. 
Resources for Establishing Simulated Use Protocols
...
FDA recommends the use of worst-case simulated use protocols throughout the 
...
the labeling when we review premarket submissions for reusable medical devices. If the 
...
29 
All 510(k)s must include proposed labels and labeling sufficient to describe the device, 
...
Review of Validation of Reprocessing Instructions 
30 
FDA has identified a subset of medical devices that pose a greater likelihood of microbial 
...
equivalence. 
B. 
Documentation in PMAs, HDEs and De Novo Requests 
...
FDA intends to appropriately consider the extent of the data needed prior to the initiation 
...
32 
8, 9, 10, 11, 12, 13 The list is not 
...
c. Low Level Disinfection: A lethal process utilizing an agent that kills vegetative forms of 
33 
...
Sterilization Wrap: A sterilization wrap (pack, sterilization wrapper, bag, or accessories) is a 
34 
device intended to be used to enclose another medical device that is to be sterilized by a health 
...
APPENDIX B.  Overview of Reusable Medical Device 
Reprocessing 
35 
As it is difficult for the health care workers responsible for reprocessing reusable devices to 
...
APPENDIX C.  Examples of Sterilization Cycles Used in 
...
3 minutes 
16 minutes 
Nonporous items (e.g., instruments) 
3 minutes 
3 minutes 
N/A 
...
APPENDIX D.  Descending Order of Resistance of 
Microorganisms to Germicidal Chemicals 
37 
...
APPENDIX E.  Devices for which a 510(k) Should Contain 
Data to Validate Reprocessing Instructions 
38 
The FDA has identified a subset of medical devices that pose a greater likelihood of microbial 
transmission and represent a high risk of infection (subclinical or clinical) if they are not 
...
21 CFR 874.4680 
JEJ 
Tubing, Instrumentation, bronchoscope (brush 
...
21 CFR 876.1500 
NZA 
Accessories, germicide, cleaning, for 
endoscopes 
21 CFR 876.1500 
OUJ 
...
21 CFR 876.1500 
FBN     
Choledochoscope and accessories, 
flexible/rigid 
21 CFR 876.1500 
FDA 
