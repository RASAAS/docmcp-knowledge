...
- eSTAR is mandatory -- submissions not in eSTAR format will not be accepted (since Oct 2023)
- Use the latest eSTAR template version (v7.0) for new submissions; v6.2 retires August 3, 2026
- eSTAR includes built-in validation checks -- incomplete submissions are automatically rejected
- Predicate device selection is critical and drives the entire submission strategy
- FDA review timeline: typically 90 calendar days for standard 510(k), 30 days for Special 510(k)
- Clinical data requirements are device-specific and driven by FDA guidance documents
- For combination products: eSTAR for 510(k)/CLIA waiver dual submissions is supported
- QMSR terminology (DHF -> Design and Development File, DMR -> Medical Device File) must be used in 2026 submissions
