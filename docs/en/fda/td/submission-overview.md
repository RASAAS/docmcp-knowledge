...
- **eSTAR is mandatory** for all 510(k) submissions since October 2023 -- non-eSTAR submissions are automatically refused
- Use the latest template version (v7.0); v6.2 retires August 3, 2026
- eSTAR includes built-in validation -- incomplete or inconsistent entries trigger automatic rejection
- **Predicate device selection** is the most critical strategic decision and drives the entire submission
- FDA review timeline: 90 calendar days for standard 510(k), 30 days for Special 510(k)
- Pre-submission meetings (Q-Sub) are strongly recommended for novel technologies, new indications, or complex devices
- Use QMSR terminology in all 2026+ submissions (Design and Development File, Medical Device File, batch records)
- MDUFA user fee must be paid before submission -- verify current fee schedule
- Clinical data requirements are highly device-specific and often determined through pre-submission interaction with FDA
