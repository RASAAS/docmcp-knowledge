...
- Chinese language requirement is strictly enforced -- all core submission documents must be in Chinese
- Notarisation requirements for imported devices add 4-8 weeks to preparation timeline
- Product list table format must be highly structured and consistent with Product Technical Requirement naming
- Master file references are increasingly used for biological materials and drug-device combinations
- For re-submissions after rejection: reference all previous receipt numbers and clearly address prior review questions
