...
- IFU is one of the most scrutinised documents in NMPA review -- formatting errors or inconsistencies can trigger review questions
- Chinese language accuracy is critical -- poor translations are a common reason for deficiency letters
- For imported devices, both the original language IFU and the Chinese IFU must be submitted; content must be consistent
- Label design should be finalised before submission as changes require supplements
- Symbol usage must conform to GB/T 15223 -- some NMPA-specific symbols may differ from ISO 15223
- Product name on the label must exactly match the Product Technical Requirement and registration application
