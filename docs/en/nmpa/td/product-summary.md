...
- [GB/T 16886 series](/en/nmpa/standards/general): Biological evaluation (ISO 10993 adoption)
- Product naming rules per NMPA regulations

## Notes for CRO

- Product description must be extremely detailed -- NMPA reviewers look for completeness more than narrative quality
- Model/specification comparison tables are heavily scrutinised -- ensure every variant is comprehensively described
- Market history section is unique to NMPA and often requires collaboration with the client's global regulatory team
- Packaging description must cover both transport and sterile barrier packaging
- For imported devices: ensure Chinese product name aligns with NMPA naming conventions
