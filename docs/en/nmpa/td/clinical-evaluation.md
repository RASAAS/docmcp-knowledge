...
| Post-market clinical | Not part of registration dossier (separate PMS system) | [PMCF](/en/eu_mdr/td/pmcf) mandatory, integrated into CER updates |
...
- **Equivalent device pathway** is the most common for imported devices with existing clinical data from other markets -- leverage CE/FDA clinical data
- Clinical trials in China must use CDE-approved protocols and NMPA-registered trial sites (GCP-compliant)
- **Clinical trial database** submission in electronic format is mandatory since 2021 -- plan data management accordingly
- Exemption list is updated periodically by NMPA -- always verify the latest version before assuming exemption eligibility
- For AI/ML medical devices: NMPA has specific clinical evaluation guidance requiring prospective clinical validation
- Clinical evaluation should clearly reference non-clinical data from Chapter 3 to build a complete evidence chain
- Translation of foreign clinical data requires certified translations and often notarisation for imported devices
