...
**IVDR reference:** Annex II §3  
**Team-NB Position Paper BPG-IVDR V2 (2025-09-03):** pp. 13–14  

## Checklist

- [ ] The DoC should include the device intended purpose if this is necessary for the identification of the
- [ ] The documentation should contain information to allow a NB reviewer to obtain a general
- [ ] understanding of the design applied to the IVD medical device. Also, provide information on the design
...
- [ ] The manufacturer shall include a detailed overview of the manufacturing processes and used
- [ ] technologies to enable understanding of the finished device. Manufacturing includes incoming
...
- [ ] In-process QC, a clear description of the test method and acceptance criteria and include
- [ ] Final release QC, a clear description of the test method and acceptance criteria and include
- [ ] references to verification and validation activities, copy of the certificate shall be included).
...
- [ ] The manufacturer shall provide the following documentation at a minimum:
