# Software Validation & Cybersecurity (IVDR)

**IVDR reference:** BPG Software & Software Validation  
**Team-NB Position Paper BPG-IVDR V2 (2025-09-03):** pp. 26–30  

## Checklist

- [ ] should include a description of the methods used in order to ensure the accuracy as given in
- [ ] Units of measurements must conform to the provisions of Council Directive 80/181/EEC.
- [ ] Provide details of the source of radiation and quantity that may be emitted.
- [ ] Provide evidence that exposure levels are appropriate for the intended purpose and have
- [ ] Provide details of the risk assessment conducted.
- [ ] Necessary detail must also be captured in the IFU especially guidance on user protection and
...
- [ ] Evidence that the requirements analysis considered IVDR Annex II 16.4, especially hardware
...
- [ ] be included here.
- [ ] from software items should be provided. This should contain the design data for each software unit
- [ ] and any interfaces between the units and any external components. Details should be provided on
