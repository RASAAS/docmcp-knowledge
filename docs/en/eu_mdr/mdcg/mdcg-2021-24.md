---
title:
  en: "MDCG 2021-24 rev.1: Guidance on Classification of Medical Devices"
document_number: MDCG 2021-24 rev.1
regulation: eu_mdr
...
This is **Rev.1** (April 2026), replacing the original October 2021 version. Key changes include clarification of "clinical procedure" terminology, new practical notes for Rule 8, and updated classification tables for Rules 10 and 12.
:::

**Document**: MDCG 2021-24 rev.1  
**Published**: April 2026  
**Regulation**: EU MDR 2017/745  
**Official PDF**: [Download](https://health.ec.europa.eu/document/download/cbb19821-a517-4e13-bf87-fdc6ddd1782e_en?filename=mdcg_2021-24_en.pdf)  
**Announcement**: [EC Public Health](https://health.ec.europa.eu/latest-updates/update-mdcg-2021-24-rev1-guidance-classification-medical-devices-april-2026-2026-04-20_en)

## Purpose

Comprehensive guidance on the classification of medical devices under MDR Annex VIII, covering all 22 classification rules with examples.

## Key Changes in Rev.1

- **Section 3.1.4 (Implantable devices)**: "Surgical procedure" replaced with "clinical procedure" — clarifies that devices introduced through non-surgical techniques (cannulas, catheters, needles) can qualify as implantable if meeting the 30-day criterion.
- **Rule 8**: Two new practical notes added (total now 7):
  - Note 1: Article 52(4) exemptions relate to conformity assessment pathways, not classification outcomes.
  - Note 7: Spinal column contact extended to all bony structures from cervical to coccyx regions.
- **Rules 10 & 12**: Classification tables updated with new examples (surgical lamps, ophthalmoscopes, fundoscopes, elastomeric pumps, balloon pumps for infusion).
- **Rule 9**: Structural reorganization for clarity.
- **Rule 16**: Updated sterilizer classification guidance.
- **Rule 22**: Clarification on defibrillator accessories.
...
- [MDCG 2022-5](./mdcg-2022-5): Borderline devices/medicinal products
- [MDCG 2023-4](./mdcg-2023-4): Medical device software/hardware combinations
