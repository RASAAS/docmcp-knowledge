...
- [MDCG 2020-7](/eu_mdr/mdcg/mdcg-2020-7): PMCF plan template (PMS integration)
- [MDCG 2022-21](/eu_mdr/mdcg/mdcg-2022-21): PSUR guidance
...
- PMS Plan scope must be agreed with client early -- it defines ongoing post-market obligations
- PMS activities that are client-executed must be clearly described so client can implement
- Threshold values should be quantitative where possible (complaint rates, event frequencies)
- For CE-marked devices: PMS Plan review is part of NB annual surveillance
- Class IIa/IIb/III devices require PSUR instead of PMS Report
