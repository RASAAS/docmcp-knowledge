...
1. Conformity assessment under EU MDR with an EU Notified Body (CE marking required)
2. Appoint a Swiss Authorised Representative (CH-REP) for foreign manufacturers
3. Register as economic operator in swissdamed to obtain CHRN (Swiss Registration Number)
4. Register devices in swissdamed UDI Devices module (mandatory from 1 July 2026)
