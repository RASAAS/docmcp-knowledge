---
title: 附件I — 通用安全和性能要求（GSPR）
description: EU MDR 2017/745 附件I规定了医疗器械必须满足的通用安全和性能要求（GSPR），是CE标志合规的核心依据。
...
在临床评价和技术文件中，制造商须：
1. 列出所有适用的GSPR条款
2. 说明满足每条GSPR的方法（协调标准 / 等效标准 / 其他方法）
3. 提供符合性证据
...
- [EUR-Lex: EU MDR 2017/745 全文（含附件I）](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32017R0745)
- [MDCG 2019-16: GSPR适用性指南](https://health.ec.europa.eu/system/files/2020-09/md_mdcg_2019_16_guidance_gspr_en_0.pdf)
