...
- eSTAR是强制性的 -- 自2023年10月起非eSTAR格式的申报不被接受
- 新申报使用最新版本模板（v7.0）；v6.2于2026年8月3日退出
- eSTAR包含内置验证检查 -- 不完整的申报将被自动拒绝
- 谓词器械选择是最关键的策略决策，驱动整个申报策略
- FDA审查时间：标准510(k)通常90个日历日，Special 510(k)为30天
- 临床数据要求因器械类型而异，通常通过与FDA的Pre-Sub沟通确定
- 2026年起的申报必须使用QMSR术语（Design and Development File、Medical Device File、batch records）
