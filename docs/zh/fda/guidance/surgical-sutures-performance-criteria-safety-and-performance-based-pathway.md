...
有关本文档中引用的FDA认可共识标准的当前版本，请参阅FDA认可共识标准数据库。2 有关在监管提交中使用共识标准的更多信息，请参阅题为《医疗器械上市参照器械交中自愿性共识标准的适当使用》的FDA指南。3
...
---
## IV. 测试性能标准
如果您的医疗器械适合通过基于安全和性能的途径（Safety and Performance Based Pathway）提交，并且您选择使用该选项，我们不期望您提供直接比较测试。有关提交非临床台架测试信息的更多信息，请参阅FDA指南《上市参照器械交中非临床台架性能测试信息的推荐内容和格式》9。
