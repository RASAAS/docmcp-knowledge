...
([参见原文脚注]);“在单一提交书中将多个器械或多个标志组合在一起”([参见原文脚注]);和“实时上市前批准申请(PMA)补充()”
...
• 对于由CDRH监管的器械,将其发送到网站[参见原文脚注] 显示的现有地址。

• 对于受《爆炸性发送到网站#0_acco/CBER/ucm385240.htm上显示的当前地址。

每份应贴上 " REAL-TIME审查要求 " 的标签,并附上FDA的答复,其中同意你关于实时审查的请求。

如果我们已安排与你举行会议,我们建议你提参照器械交实时PMA补编,以便FDA审查员做好审查的充分准备。如果我们在会议至少三周前仍未收到你的提交,我们通常将重新安排时间,以确保审查人员有充分的准备时间,以避免会议无结果。
