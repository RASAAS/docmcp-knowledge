...
可能存在CFG或CFG-NE由与具有不同所有人/经营者编号的机构有业务关系的一方请求的情形。若因该机构被认定不符合而拒绝CFG或CFG-NE，CFG或CFG-NE请求人将收到拒绝电子邮件，表明拒绝基于与该机构相关的事项。但是，根据适用的披露要求，⁹ 实质性摘要将不会通过电子邮件发送给CFG或CFG-NE请求人，而是在CFG或CFG-NE请求人同意可将其待决的CFG或CFG-NE请求告知另一机构的参照器械下，通过该不符合机构的所有人、经营者或负责人发送给该不符合机构。
对于未结召回，FDA拟基于被召回产品的当前状态决定是否签发CFG或CFG-NE。例如，若一方为已经纠正的被召回产品请求CFG或CFG-NE，FDA将按当前召回审查流程审查纠正文件和产品最终检测，以确定是否应签发CFG或CFG-NE。
对于存在未结特定批次召回的产品线，未被召回的批次可包含在CFG或CFG-NE中，参照器械是企业签署声明表明其将不装运受召回约束的产品批次。
...
该计划是否足以应对检查观察中记录的违规。若FDA认为需要对所提交的纠正计划进行澄清，FDA可自行决定在作出决定前与该机构的所有人、经营者或负责人启动进一步沟通。
...
CBER和CDRH将与ORA协作审查新信息，并拟在90日内作出答复，取决于FDA的资源、所呈不符合问题的复杂性以及该机构的响应情况。
