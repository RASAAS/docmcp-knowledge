...
简介
本注意要点文件补充既有的体外诊断器械批准或通告上市参照器械交FDA指南。所请求信息旨在全面但可能并非穷尽。重点在于FDA在审评妇科标本细胞学器械时的特别关切。
这些产品包括：
1. 用于初始宫颈阴道标本的采集器械[刮板、刷子等]（根据21 CFR 884.4530监管，II类）
2. 用于制作薄层或单层玻片的细胞悬液器械（未分类）
3. 染色器械（根据21 CFR 864.3800监管，豁免）
4. 计算机辅助细胞定位器械（根据21 CFR 864.5260监管）
...
本历史注意要点文件的其余部分提供关于分析方法验证、玻片制备质量、阅片者表现、与手动方法的比较以及提交组织的额外细节。制造商应将该文件与现行IVD上市参照器械交指南及现行特殊控制一并使用。
