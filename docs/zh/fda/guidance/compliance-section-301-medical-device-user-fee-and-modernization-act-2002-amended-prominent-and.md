...
办公室笔通常印有制造商或上市商的标记。笔上的名字足够大,用户可以使用笔阅读。
...
如果原始器械或附加器械在2006年8月1日之前没有明显明显地印上OEM的标记,那么在2006年8月1日之前,OEM的标记就会明显地印上。但却在任何以后的日期这样做,然后,后处理的SUD或其附件必须在后处理器合法上市之前突出和明显地标出该后处理器的标记。
