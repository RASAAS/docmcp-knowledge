...
::: info
本页目前为中文元数据页。英文全文见 [/en/fda/guidance/regulatory-requirements-hearing-aid-devices-and-personal-sound-amplification-products](/en/fda/guidance/regulatory-requirements-hearing-aid-devices-and-personal-sound-amplification-products)。中文全文将在英文结构质检完成后的后续波次提供。
:::
