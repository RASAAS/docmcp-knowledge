...
### F. 电子数据
我们建议提交您研究中任何统计分析中使用的数据,包括病人信息、疾病或正常状况、损伤大小、损伤类型、病情等。为精简器械审查,在可能的情况下,可以电子方式(如在光盘上)进行成像和扫描设置以及成像和数据特性。关于以电子方式提交数据的更多信息,请见FDA题为《预先市场文件的临床数据》的白皮书。此外,FDA关于eCopy方案18 和FDA题为 " eCopy医疗器械提交方案 " 的指导的网页。 19
