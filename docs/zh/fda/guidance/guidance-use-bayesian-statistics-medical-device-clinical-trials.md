...
本指南代表FDA（FDA或FDA）目前对该主题的观点。它不为任何人确立任何权利，对FDA或公众亦不具约束力。若替代方法满足适用法规与条例的要求，您可采用该替代方法。
...
器械试验常面临样本量有限、可获得历史器械数据、需要适应性设计或希望对成功概率作直接概率陈述等情形。贝叶斯框架可系统纳入既往信息并支持灵活设计，参照器械是科学论证充分。
