...
FDA认识到,PCLC器械可能对患者护理具有多重潜在好处(见第二节)。在作出监管决定时应考虑这一点,并建议制造商参考FDA现有的指南文件,收集和编制用于提交监管提交的资料,以支持确定效益风险。例如,见FDA指南文件“在医疗器械预先市场批准和De Novo分类中确定获益-风险时应考虑的因素”23 和“获益-风险”。
