...
features:
  ...
  - title: FDA
    details: 21 CFR 法规、FDA 认可共识标准（AAMI/ASTM）、指南文件
  - title: NMPA
...
本知识库是一个开放的医疗器械合规知识库，由 [RASAAS](https://github.com/RASAAS) 和社区共同维护。
...
请查看 [CONTRIBUTING.md](https://github.com/RASAAS/docmcp-knowledge/blob/main/CONTRIBUTING.md) 了解如何贡献新内容、翻译或错误修正。
