...
const zhSidebar = Object.assign(
  {
    '/zh/insights/': [
      { text: '法规解读首页', link: '/zh/insights/' },
      {
        text: '临床评价方法论', link: '/zh/insights/clinical-evaluation',
        collapsed: true,
        items: [
          { text: '临床评价报告 (CER)', link: '/zh/insights/clinical-evaluation/cer' },
          { text: '数据收集报告 (DCR)', link: '/zh/insights/clinical-evaluation/dcr' },
          { text: '文献检索计划 (LSP)', link: '/zh/insights/clinical-evaluation/lsp' },
          { text: '等同器械', link: '/zh/insights/clinical-evaluation/equivalency' },
          { text: '临床背景信息 (SOTA)', link: '/zh/insights/clinical-evaluation/sota' },
          { text: 'MDCG 2025-9 解读', link: '/zh/insights/clinical-evaluation/mdcg-2025-9' },
        ],
      },
      { text: '法规解读分析', link: '/zh/insights/analysis' },
      { text: 'NMPA 合规动态', link: '/zh/insights/nmpa-updates' },
      { text: 'EU MDR 合规动态', link: '/zh/insights/eu-mdr-updates' },
      { text: 'FDA 合规动态', link: '/zh/insights/fda-updates' },
    ],
    '/zh/eu_mdr/': [
      ...
      themeConfig: {
        ...
        sidebar: {
          ...
          '/en/insights/': [
            ...
            { text: 'Clinical Evaluation', link: '/en/insights/clinical-evaluation' },
